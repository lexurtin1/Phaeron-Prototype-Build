(() => {
  ...
  const PORTS_A = [
    [380 / 1600, (310 + 132) / 700],
    [720 / 1600, (345 + 132) / 700],
    [1120 / 1600, (295 + 132) / 700],
    [1420 / 1600, (330 + 132) / 700]
  ];
  const PORTS_B = [
    [220 / 1600, (140 + 132) / 700],
    [640 / 1600, (110 + 132) / 700],
    [980 / 1600, (155 + 132) / 700],
    [1360 / 1600, (130 + 132) / 700]
  ];
  ...
  function connectSpokes(scene, alphaA, alphaB, showHub) {
    ...
    const stopPad = mobile.matches ? 32 : 44;
    origins.forEach(({ p, alpha }, i) => {
      ...
      path.style.opacity = String(clamp(alpha * 0.4, 0, 0.4));
    });
