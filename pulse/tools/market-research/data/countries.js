/* ================================================================
   ============   EDITABLE COUNTRY DATA — EDIT HERE   =============
   ================================================================
   Keyed by ISO3 (UPPERCASE). The UI updates automatically.

   ADD A NEW COUNTRY: copy the TEMPLATE at the bottom of this object,
   change the key + fields, save, refresh.

   Countries without a record stay clickable but show
   ...
   ORDER-FLOW DIAGRAM (two options, use either or both):
     ...
     flow_diagram : [] -> a list of stages the app DRAWS automatically.
        Each stage = { label: "Investor", mode: "auto" | "manual" | "mixed" }
        mode colours the box: auto=green, mixed=amber, manual=red.
   If flow_image is set it takes priority; otherwise flow_diagram is drawn;
   if both are empty, the flow section is hidden.

   All other fields are plain factual text shown verbatim.
   ================================================================ */
...
const COUNTRY_DATA = {
  ...
  "GBR": {
    ...
    // Phaeron home market + EMX/Euroclear; UK Accelerated Settlement
  ...
  "AUS": {
    ...
    mutual_fund_relevance:"Large managed-funds and superannuation market already covered by Phaeron.",
    growth_signal:"Superannuation system compounding within an already mature Phaeron footprint.",
    dominant_order_model:"Phaeron-led automated order routing.",
    current_order_channels:"Phaeron Network provides near-complete market coverage.",
    manuality_snapshot:"Approximately 100% of the addressable market is controlled through Phaeron coverage.",
    regulatory_openness:"Moderate-high — efficiency agenda politically supported.",
    risks_or_barriers:"Market is already fully covered by Phaeron, leaving little incremental routing opportunity.",
    // Phaeron provides near-complete coverage; superannuation flows are
    ...
    flow_diagram:[
      ...
      {label:"Phaeron Network", mode:"auto"},
      {label:"Fund Administrator", mode:"auto"},
      {label:"Fund Manager", mode:"auto"}
    ],
    last_updated:"2025-05-28"
  },
...
/* ================================================================
   ============   END EDITABLE DATA — APP LOGIC BELOW   ==========
   ================================================================ */

/* ================================================================
   ===========   EDITABLE FULL RESEARCH NOTES (Markdown)   =======
   ================================================================
   Keyed by ISO3. Each value is the complete Markdown research note,
   shown (rendered) when the user clicks Expand on a profiled country.
   Edit freely; this is plain Markdown inside backtick template strings.
   To add a note for a new country, add  "XXX": `...markdown...`,
   ================================================================ */
