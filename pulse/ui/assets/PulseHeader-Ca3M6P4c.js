import{r as L,j as e}from"./pulse-ui-CKv6LqTw.js";import{R as k,T,P as F,M as P}from"./Triangle-DsNpnrqg.js";import{R as b}from"./RadialNav-Cm5DLQIf.js";function q(i){const r=i.replace("#","");return[parseInt(r.slice(0,2),16)/255,parseInt(r.slice(2,4),16)/255,parseInt(r.slice(4,6),16)/255]}const G=`
attribute vec2 uv;
