...
exports.MODE_DRAWS = MODE_DRAWS;
exports.MODE_FRAMES = MODE_FRAMES;
exports.STATE_TO_MODE = STATE_TO_MODE;
exports.angleDelta = angleDelta;
exports.countDots = countDots;
exports.fibDir = fibDir;
exports.finalizeFrame = finalizeFrame;
exports.frac = frac;
exports.hashD = hashD;
exports.lerp = lerp;
exports.makeProj = makeProj;
exports.paint = paint;
exports.paintFrame = paintFrame;
exports.paintLines = paintLines;
exports.radiusScale = radiusScale;
exports.resolvePreset = resolvePreset;
exports.scaleCounts = scaleCounts;
