...
export const PULSE_CARD_TOOLS: PulseTool[] = [
  ...
  },
  {
    ...
    num: '04',
    title: 'Studio',
    description: 'Value prop, architecture presentation, and artifacts.',
...
export const RADIAL_DESTINATIONS: NavDestination[] = [
  ...
  { id: 'studio', label: 'Studio', href: '/tools/value-prop/index.html', icon: <DemoIcon size={22} /> },
...
export const PULSE_NAV = [
  ...
  { label: 'Studio', href: '/tools/value-prop/index.html' },
