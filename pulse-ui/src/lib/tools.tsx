...
function NetworkIcon() {
  return (
    <svg width="54" height="54" viewBox="0 0 48 48" fill="none" aria-hidden>
      ...
      />
      <circle cx="11" cy="29" r="2" fill="#2d9a8e" />
      <circle cx="37" cy="25" r="2" fill="#0fb89c" />
      <circle cx="38" cy="31" r="2" fill="#35b57e" />
    </svg>
  );
}
  ...
  return (
    <svg width="54" height="54" viewBox="0 0 48 48" fill="none" aria-hidden>
      ...
      <g clipPath="url(#csHeat)">
        <rect x="8" y="8" width="14" height="12" rx="3" fill="#dcefec" />
        <rect x="22" y="8" width="18" height="10" rx="3" fill="#7cc4bb" />
        <rect x="8" y="20" width="12" height="20" rx="3" fill="#2d9a8e" />
        <rect x="20" y="18" width="11" height="12" rx="3" fill="#0fb89c" />
        <rect x="30" y="18" width="12" height="22" rx="3" fill="#b3ddd7" />
        <rect x="20" y="30" width="11" height="12" rx="3" fill="#35b57e" />
      </g>
      <circle cx="24" cy="24" r="14" stroke="#c3cdd5" strokeWidth="1.4" />
    ...
    <svg width="54" height="54" viewBox="0 0 48 48" fill="none" aria-hidden>
      <defs>
        <linearGradient id="csHub" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0" stopColor="#2d9a8e" />
          <stop offset="1" stopColor="#35b57e" />
        </linearGradient>
      </defs>
      ...
      <polygon points="24,7 20.54,9 20.54,13 24,15 27.46,13 27.46,9" fill="none" stroke="#7cc4bb" strokeWidth="1.4" />
      <polygon
...
function MarketplaceIcon() {
  return (
    <svg width="54" height="54" viewBox="0 0 48 48" fill="none" aria-hidden>
      ...
      <path d="M24 20 V13" stroke="#0fb89c" strokeWidth="1.6" strokeLinecap="round" />
      <path d="M28 24 H35" stroke="#0fb89c" strokeWidth="1.6" strokeLinecap="round" />
      <path d="M24 28 V35" stroke="#2d9a8e" strokeWidth="1.6" strokeLinecap="round" />
      <path d="M20 24 H13" stroke="#2d9a8e" strokeWidth="1.6" strokeLinecap="round" />
      <path d="M20 20 H15.5 V15.5" stroke="#35b57e" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M28 28 H32.5 V32.5" stroke="#35b57e" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
      <rect x="19.5" y="19.5" width="9" height="9" rx="1.6" fill="#dcefec" stroke="#2d9a8e" strokeWidth="1.3" />
      <circle cx="24" cy="13" r="2" fill="#0fb89c" />
      <circle cx="35" cy="24" r="2" fill="#0fb89c" />
      <circle cx="24" cy="35" r="2" fill="#2d9a8e" />
      <circle cx="13" cy="24" r="2" fill="#2d9a8e" />
      <circle cx="15.5" cy="15.5" r="1.8" fill="#35b57e" />
      <circle cx="32.5" cy="32.5" r="1.8" fill="#35b57e" />
    </svg>
  );
}
...
function IntelligenceIcon() {
  return (
    <svg width="54" height="54" viewBox="0 0 48 48" fill="none" aria-hidden>
      ...
      <circle cx="29.5" cy="30.5" r="6.5" fill="#ffffff" stroke="#0fb89c" strokeWidth="1.9" />
      <line x1="34.4" y1="35.4" x2="39" y2="40" stroke="#0fb89c" strokeWidth="2.1" strokeLinecap="round" />
    </svg>
  );
}
...
function MovementIcon() {
  return (
    <svg width="54" height="54" viewBox="0 0 48 48" fill="none" aria-hidden>
      ...
      <circle cx="24" cy="24" r="11" stroke="#0fb89c" strokeWidth="1.6" className="icon-pulse" />
      <circle cx="24" cy="24" r="11" stroke="#35b57e" strokeWidth="1.6" className="icon-pulse icon-pulse-2" />
      <circle cx="24" cy="24" r="11" stroke="#2d9a8e" strokeWidth="1.6" className="icon-pulse icon-pulse-3" />
  ...
  return (
    <svg width="54" height="54" viewBox="0 0 48 48" fill="none" aria-hidden>
      ...
      <polyline
        ...
        strokeLinejoin="round"
      />
      <circle cx="41" cy="16" r="2.2" fill="#35b57e" />
    </svg>
  );
}
