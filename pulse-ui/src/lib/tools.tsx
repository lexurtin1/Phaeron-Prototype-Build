...
function NetworkIcon() {
  return (
    <svg width="54" height="54" viewBox="0 0 48 48" fill="none" aria-hidden>
      ...
      <circle cx="37" cy="25" r="2" fill="#E11D48" />
      <circle cx="38" cy="31" r="2" fill="#BE123C" />
    </svg>
  );
}
  ...
  return (
    <svg width="54" height="54" viewBox="0 0 48 48" fill="none" aria-hidden>
      ...
      <g clipPath="url(#csHeat)">
        ...
        <rect x="20" y="18" width="11" height="12" rx="3" fill="#E11D48" />
        <rect x="30" y="18" width="12" height="22" rx="3" fill="#B8C7DE" />
        <rect x="20" y="30" width="11" height="12" rx="3" fill="#BE123C" />
      </g>
      <circle cx="24" cy="24" r="14" stroke="#c3cdd5" strokeWidth="1.4" />
...
function MarketplaceIcon() {
  return (
    <svg width="54" height="54" viewBox="0 0 48 48" fill="none" aria-hidden>
      ...
      <path d="M24 20 V13" stroke="#E11D48" strokeWidth="1.6" strokeLinecap="round" />
      <path d="M28 24 H35" stroke="#E11D48" strokeWidth="1.6" strokeLinecap="round" />
      ...
      <path d="M20 20 H15.5 V15.5" stroke="#BE123C" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M28 28 H32.5 V32.5" stroke="#BE123C" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round" />
      <rect x="19.5" y="19.5" width="9" height="9" rx="1.6" fill="#E4EAF3" stroke="#1B3A6B" strokeWidth="1.3" />
      <circle cx="24" cy="13" r="2" fill="#E11D48" />
      <circle cx="35" cy="24" r="2" fill="#E11D48" />
      <circle cx="24" cy="35" r="2" fill="#1B3A6B" />
      <circle cx="13" cy="24" r="2" fill="#1B3A6B" />
      <circle cx="15.5" cy="15.5" r="1.8" fill="#BE123C" />
      <circle cx="32.5" cy="32.5" r="1.8" fill="#BE123C" />
    </svg>
  );
}
...
function IntelligenceIcon() {
  return (
    <svg width="54" height="54" viewBox="0 0 48 48" fill="none" aria-hidden>
      ...
      <circle cx="29.5" cy="30.5" r="6.5" fill="#ffffff" stroke="#E11D48" strokeWidth="1.9" />
      <line x1="34.4" y1="35.4" x2="39" y2="40" stroke="#E11D48" strokeWidth="2.1" strokeLinecap="round" />
    </svg>
  );
}
...
function MovementIcon() {
  return (
    <svg width="54" height="54" viewBox="0 0 48 48" fill="none" aria-hidden>
      ...
      <circle cx="24" cy="24" r="11" stroke="#E11D48" strokeWidth="1.6" className="icon-pulse" />
      <circle cx="24" cy="24" r="11" stroke="#BE123C" strokeWidth="1.6" className="icon-pulse icon-pulse-2" />
  ...
  return (
    <svg width="54" height="54" viewBox="0 0 48 48" fill="none" aria-hidden>
      ...
      <polyline
        ...
        strokeLinejoin="round"
      />
      <circle cx="41" cy="16" r="2.2" fill="#BE123C" />
    </svg>
  );
}
