...
export const PULSE_CARD_TOOLS: PulseTool[] = [
  ...
  },
  {
    ...
    num: '04',
    title: 'Studio',
    description: 'Primary architecture story, value prop, presentation, and artifacts.',
...
export const RADIAL_DESTINATIONS: NavDestination[] = [
  ...
  { id: 'studio', label: 'Studio', href: '/tools/architectural/index.html', icon: <DemoIcon size={22} /> },
...
export const PULSE_NAV = [
  ...
  { label: 'Studio', href: '/tools/architectural/index.html' },
